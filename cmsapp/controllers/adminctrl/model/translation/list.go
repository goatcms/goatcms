...
func NewList(dp dependency.Provider) (*List, error) {
	...
	if ctrl.view, err = ctrl.deps.Template.View(goathtml.DefaultLayout, "admin/model/translation/list", nil); err != nil {
		return nil, err
	}
	return ctrl, nil
}
...
func (c *List) Get(requestScope app.Scope) {
	...
	if rows, err = c.deps.Finder.Find(requestScope, entities.TranslationMainFields); err != nil {
