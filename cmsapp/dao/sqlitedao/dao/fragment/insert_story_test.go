...
func doInsertWithoutIDStory(t *testing.T) (bool, *sql.DB, *entities.Fragment) {
	var (
		resultID int64
		ok       bool
		db       *sql.DB
...
func doInsertWithIDStory(t *testing.T) (bool, *sql.DB, *entities.Fragment) {
	var (
		resultID   int64
		ok         bool
		db         *sql.DB
