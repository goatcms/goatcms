...
func NewITApp(host string) (mapp app.App, err error) {
	...
	options.ConfigScope.Set("app.baseURL", "http://localhost")
	options.ConfigScope.Set("oauth.github.app", "")
	options.ConfigScope.Set("oauth.github.secret", "")
	options.ConfigScope.Set("router.security.mode", "HTTP")
